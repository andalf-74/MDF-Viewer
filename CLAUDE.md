...
**As of 2026-07-12:** v2.1.1 is still the last released version (https://github.com/andalf-74/MDF-Viewer/releases/tag/v2.1.1). 1639 tests passing. The **2.1.1 Bugfixing milestone is fully resolved**, all bugs closed. Fix-by-fix detail lives in `CHANGELOG.md`'s `[2.1.1]` entry, not repeated here.
