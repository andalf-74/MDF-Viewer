...
class SignalTableProtocol(Protocol):
    ...
    def rename_stripe_segment(self, stripe: Any, name: str) -> None: ...
    # X-Axis Signal tabs (#86)
...
class SignalInfoProtocol(Protocol):
    def set_metadata(self, metadata: SignalMetadata, display_name: str | None = None) -> None: ...
...
class CursorValueSinkProtocol(Protocol):
    ...
    # X-Axis Signal tabs (#86, REQ-XAXIS-032)
    def update_axis_cursor_values(self, c1: str, c2: str, delta: str) -> None: ...
