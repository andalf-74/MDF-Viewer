...
**Latest release — v2.3.1:** https://github.com/andalf-74/MDF-Viewer/releases/tag/v2.3.1 — ships `MDF-Viewer-2.3.1-Setup.exe` (installer) and `MDF-Viewer-2.3.1-Windows.zip` (portable).
