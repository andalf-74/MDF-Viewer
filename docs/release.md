...
**Latest release — v2.3:** https://github.com/andalf-74/MDF-Viewer/releases/tag/v2.3 — ships `MDF-Viewer-2.3-Setup.exe` (installer) and `MDF-Viewer-2.3-Windows.zip` (portable).
